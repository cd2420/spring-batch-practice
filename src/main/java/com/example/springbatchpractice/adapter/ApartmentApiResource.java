package com.example.springbatchpractice.adapter;
 ...
 * 2. LAWD_CD - 법정동 코드 10자리 중 앞에 5자리 - 구 지역코드 guLawdCd
 * 3. DEAL_YMD - 거래가 발생한 년월. 예) 202212
 */
@Slf4j
@Component
public class ApartmentApiResource {
    ...
    public Resource getResource(String lawdCd, YearMonth yearMonth) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new IllegalArgumentException("url path가 잘못되었습니다. url : " + url);
        }
    }
}
